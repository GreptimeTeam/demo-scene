...
def metric_generator():
    ...
    vendor = random.choice(["AWS", "GCP", "Azure"])
    region = random.choice(["us-west", "us-east", "eu-west", "eu-east"])
    size = random.choice(["s", "m", "l", "xl"])
    line = f"monitor,host={host},vendor={vendor},region={region},size={size} cpu={cpu}"
